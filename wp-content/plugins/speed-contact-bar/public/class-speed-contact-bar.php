...
class Speed_Contact_Bar {
	...
	private function __construct() {
		...
		$this->valid_social_networks = array( 'soundcloud', 'facebook', 'googleplus', 'twitter', 'instagram', 'pinterest', 'youtube', 'linkedin', 'xing', 'flickr', 'slideshare', 'tumblr', 'vimeo', 'imdb', 'yelp' );
