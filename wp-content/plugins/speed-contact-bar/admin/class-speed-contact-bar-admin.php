...
class Speed_Contact_Bar_Admin {
	...
	public function print_admin_css() {
		...
		if ( $this->plugin_screen_hook_suffix == $screen->id ) {
			...
			$pngs = array( 'imdb', 'yelp', 'soundcloud' ); // PNG image file namens
			...
			'4th_section' => array(
				...
				'options' => array(
					'show_texts' => array(
						...
						'desc'    => __( 'Activate to keep the phone numbers and mail address displayed in small displays', $this->plugin_slug ),
					),
