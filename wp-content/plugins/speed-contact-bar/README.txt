...
Tags: address, bottom, cell phone, contact, contacts, e-mail, email, facebook, flickr, g+, google plus, google+, icons, imdb, instagram, link, linkedin, number, phone, pinterest, position, responsive, slideshare, social media, soundcloud, telephone, top, transparent, tumblr, twitter, url, vimeo, web, xing, yelp, youtube
...
The plugin is available in English and German (Deutsch).
...
14. Yelp
15. Youtube
16. any further content you wish by using the filter hook `speed-contact-bar-icons`
